...
class Configuration:
    ...
    def read(self, profile):
        ...
        if config_parser.has_section(profile):
            ...
            self.role_arn = util.Util.unicode_to_string_if_needed(util.Util.default_if_none(config_parser[profile].get('aws_google_auth_role_arn', None), self.role_arn))
            self.sp_id = util.Util.unicode_to_string_if_needed(util.Util.default_if_none(config_parser[profile].get('aws_google_auth_sp_id', None), self.sp_id))
            ...
            self.username = util.Util.unicode_to_string_if_needed(util.Util.default_if_none(config_parser[profile].get('aws_google_auth_username', None), self.username))
